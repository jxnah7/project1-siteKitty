...
let attemptsLeft = 3;
    ...
    function startGame() {
      randomNumber = Math.floor(Math.random() * 20) + 1; // Random number between 1-20
      attemptsLeft = 3;
    ...
    function submitGuess() {
      ...
      if (isNaN(userGuess) || userGuess < 1 || userGuess > 20) {
        document.getElementById("feedback").textContent = "Please enter a valid number between 1 and 20!";
        return;
      }
